<template>
  <div class="layout">
    ...
    <div class="form-container">
      <h2 class="text-center mb-4 text-2xl">Toll Plaza Section Detail</h2>
      ...
      <div class="form-grid">
        ...
        <div class="form-group">
          <label for="Toll">Type of Toll</label>
          <select id="Toll" v-model="form.Toll">
            <option disabled value="">-- Choose Type --</option>
            <option>Barrier Only</option>
            <option>Barrier with infrastructure</option>
            
          </select>
        </div>
        <div class="form-group">
          <label for="Noofbooths">Number of booths in each direction</label>
          <input id="Noofbooths" type="number" v-model="form.Noofbooths" />
        </div>
         <div class="form-group">
