  ...
  <div class="layout">
    ...
    <div class="form-container">
      ...
      <div class="form-grid">
        ...
        <div class="form-group">
          <label for="drainage">Select Drainage</label>
          <select id="drainage" v-model="form.drainage">
            <option disabled value="">-- Choose Drainage --</option>
            <option>Drainage 1</option>
            <option>Drainage 2</option>
            <option>Drainage 3</option>
          </select>
        </div>
        <div class="form-group">
...
<div class="form-row">
  <div class="form-group flex-half toggle-group">
    <label class="toggle-label">Does have cat eyes</label>
    <label class="switch">
      <input type="checkbox" v-model="form.hasCatEyes" />
      <span class="slider"></span>
    </label>
  </div>
  <div class="form-group flex-half toggle-group">
    <label class="toggle-label">Is drain open</label>
    <label class="switch">
      <input type="checkbox" v-model="form.isDrainOpen" />
      <span class="slider"></span>
    </label>
  </div>
</div>
