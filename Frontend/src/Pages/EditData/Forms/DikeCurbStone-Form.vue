<template>
  <div class="layout">
    ...
    <div class="form-container">
      <h2 class="text-center mb-4 text-2xl">Dike & Curb Stone Section Detail</h2>
      ...
      <div class="form-grid">
        ...
        <div class="form-group">
          <label for="DikeType">Type of Dike & Curb Stone</label>
          <select id="DikeType" v-model="form.DikeType">
            <option disabled value="">-- Choose Dike & Curb Stone Type --</option>
            <option>PCC</option>
            <option>Stone</option>
          </select>
        </div>
        <div class="form-group">
          <label for="DikeSide">Dike & Curb Stone Side</label>
          <select id="DikeSide" v-model="form.DikeSide">
            <option disabled value="">-- Choose Dike & Curb Stone Side --</option>
        ...
        <div class="form-group">
          <label for="DikeCurbStoneCondition">Condition</label>
          <select id="DikeCurbStoneCondition" v-model="form.DikeCurbStoneCondition">
