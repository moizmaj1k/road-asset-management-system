<template>
  <div class="layout">
    ...
    <div class="form-container">
      <h2 class="text-center mb-4 text-2xl">Commercial Entity Section Detail</h2>
      ...
      <div class="form-grid">
        ...
        <div class="form-group">
          <label for="CommercialEntityType">Commercial Entity Type</label>
          <select id="CommercialEntityType" v-model="form.CommercialEntityType">
