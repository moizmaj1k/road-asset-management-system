<template>
  <div class="layout">
    ...
    <div class="form-container">
      <h2 class="text-center mb-4 text-2xl">Culvert Section Detail</h2>
      ...
      <div class="form-grid">
        ...
        <div class="form-group">
          <label for="signboard">Select Signboard</label>
          <select id="signboard" v-model="form.signboard">
            <option disabled value="">-- Choose Signboard --</option>
            <option>Signboard 1</option>
            <option>Signboard 2</option>
            <option>Signboard 3</option>
          </select>
        </div>

        <div class="form-group">
          <label for="signboardType">Signboard Type</label>
          <select id="signboardType" v-model="form.signboardType">
            <option disabled value="">-- Choose Signboard Type --</option>
            <option>Warning</option>
            <option>Informatory</option>
            <option>Regulatory</option>
            <option>Gantry</option>
            <option>Milestone</option>
            <option>RD Post</option>
          </select>
        </div>
        <div class="form-group">
          <label for="signboardSide">Signboard Side</label>
          <select id="signboardSide" v-model="form.signboardSide">
            <option disabled value="">-- Choose Signboard Side --</option>
