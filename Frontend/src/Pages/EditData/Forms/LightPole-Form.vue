<template>
  <div class="layout">
    ...
    <div class="form-container">
      <h2 class="text-center mb-4 text-2xl">Light Pole Section Detail</h2>
      ...
      <div class="form-grid">
        ...
        <div class="form-group">
          <label for="LightPoleType">Type of Light Pole</label>
          <select id="LightPoleType" v-model="form.LightPoleType">
            <option disabled value="">-- Choose Type --</option>
            <option>Single Arm</option>
            <option>Double Arm</option>
            <option>Multi Arm</option>
            <option>Flood Light</option>
          </select>
        </div>
         <div class="form-group">
          <label for="LightPoleSide">Light Pole Side</label>
          <select id="LightPoleSide" v-model="form.LightPoleSide">
         ...
         <div class="form-group">
          <label for="SignBoardCondition">Condition</label>
          <select id="SignBoardCondition" v-model="form.SignBoardCondition">
        ...
        <!-- End Lat & End Lon side-by-side -->
          <div class="form-group toggle-group">
            <label class="toggle-label">Is Light Pole Solar?</label>
            <label class="switch">
              <input type="checkbox" v-model="form.isLightPoleSolar" />
              <span class="slider"></span>
            </label>
          
          </div>
          <div class="form-group toggle-group" v-if="form.isLightPoleSolar">
  <div class=" toggle-group">
            <label class="toggle-label">Is Solar Panel in place?</label>
            <label class="switch">
              <input type="checkbox" v-model="form.isSolarPanelInPlace" />
              <span class="slider"></span>
            </label>
          
          </div>
 <div class=" toggle-group toggle-group">
            <label class="toggle-label">Is Battery Box in place?</label>
            <label class="switch">
              <input type="checkbox" v-model="form.isBatteryBoxInPlace" />
              <span class="slider"></span>
            </label>
...
const form = reactive({
  ...
  typeofheadwalls: "",
  waterwayclearance: "",
    isLightPoleSolar: false,
  isSolarPanelInPlace: false,
  isBatteryBoxInPlace: false,
});
