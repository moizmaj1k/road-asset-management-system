<template>
  <div class="layout">
    ...
    <div class="form-container">
      <h2 class="text-center mb-4 text-2xl">Interchange Section Detail</h2>
      ...
      <div class="form-grid">
        ...
        <div class="form-group">
          <label for="interchangeName">Interchange Name</label>
          <input
            id="interchangeName"
            type="text"
            placeholder="Enter interchange name"
            v-model="form.interchangeName"
          />
        </div>
        
        <div class="form-group">
          <label for="InterchangeType">Type of Interchange</label>
          <select id="InterchangeType" v-model="form.InterchangeType">
